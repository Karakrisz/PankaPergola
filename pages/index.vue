      ...
      >
        <div class="subpage-content">
          ...
          <div class="trust-banner">
            <h2 class="page-color main-title">BIOKLIMATIKUS PERGOLÁK ÉS ÁRNYÉKOLÁS</h2>
            <p class="banner-subtitle">
              Egész éves kényelem és energiahatékonyság a teraszán
            </p>
            <div class="trust-elements">
              <div class="trust-item">
                <span class="trust-icon">✓</span>
                <strong>Egész éves kényelem</strong> - Nyáron árnyék és szellőzés,
                télen napsütés és védelem
              </div>
              <div class="trust-item">
                <span class="trust-icon">✓</span>
                <strong>Energiahatékonyság</strong> - Akár 30-40% energiamegtakarítás
                az intelligens árnyékoláson keresztül
              </div>
              <div class="trust-item">
                <span class="trust-icon">✓</span>
                <strong>Értéknövelés</strong> - Prémium minőség, amely 5-7%-kal
          ...
          <div class="benefits-grid">
            <div class="benefit-card">
              ...
              <p>
                <strong>Rugalmas megoldás</strong> - Mozgatható lamellák biztosítják
                az optimális feltételeket minden időben
              </p>
            </div>
            <div class="benefit-card">
              <h3>Intelligens klímaszabályozás</h3>
              <p>
                <strong>Okos árnyékolás</strong> - Automatizálható, amely csökkenti
                a fűtési és hűtési költségeket
              </p>
            </div>
            <div class="benefit-card">
              <h3>Prémium megjelenés</h3>
              <p>
                <strong>Elegáns design</strong> - Tartós alumínium, tetszőleges RAL
                szín, bármilyen építészeti stílushoz illeszkedik
              </p>
            </div>
          </div>
  
          <h2 class="page-color section-heading">KÉRJEN INGYENES FELMÉRÉST ÉS AJÁNLATOT</h2>
            ...
            <div class="form-section">
              ...
              <div class="form-group">
                ...
                >
                  ...
                  <option value="pergola-automatika">Pergola automatika felszerelés</option>
